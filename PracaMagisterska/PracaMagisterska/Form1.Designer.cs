...
namespace PracaMagisterska
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.pictureBoxControl1 = new PictureBoxControl(PictureBoxType.Ref);
			this.pictureBoxControl2 = new PictureBoxControl(PictureBoxType.Calc);
